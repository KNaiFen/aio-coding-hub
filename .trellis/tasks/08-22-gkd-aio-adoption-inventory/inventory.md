...
| Accepted bundle `bin/gkd-role` | Runtime entrypoint for bundle/project verification and automatic route gates | GKD generic runtime; the invoking session must provide Python 3.11+ before any AIO adapter can rely on it | B preflight |
