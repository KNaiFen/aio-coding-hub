...
There are no material open questions for this documentation-only milestone. Later implementation must stop if the pinned bundle, AIO repository identity, or required-check policy differs from these recorded facts.
