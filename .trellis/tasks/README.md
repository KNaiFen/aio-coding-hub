...
|---|---|---|---|---|---|---|---|---|
| [`08-13-cross-provider-model-routing`](./08-13-cross-provider-model-routing/) | planning（规划已冻结；等待 TUI 依赖合并） | `feat/cross-provider-model-routing` | `875ff441c5ba9f1a7f235ad95dadb945a41bba61` | `71392b672ee665b6ee96e13bf3871b2816185873` | `/Users/knaifen/Documents/Codex/aio-coding-hub/08-13-cross-provider-model-routing` | 尚未创建 | main session（规划）；依赖合并后交接执行 session | TUI PR #136（当前 OPEN/CLEAN，head `2b12c68cd99f7bc7c21fb8fa2b5354c9992a229b`）合并后，main fetch origin、更新完整 base/规划登记并运行 `task.py start`；本任务不改 TUI `format.rs`。 |
