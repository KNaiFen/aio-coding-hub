...
|---|---|---|---|---|---|---|---|---|
| [`08-10-github-actions-governance`](./08-10-github-actions-governance/) | implementation（待执行 session 启动） | `fix/upstream-sync-pr-resolution` | `82820b2ea10ec6028d1fcb8d130a993bfae39b6d` | `2016c25ef7cb6ae524f3f2b4e86996ef923981a3` | `/Users/knaifen/Documents/Codex/aio-coding-hub/08-11-upstream-sync-pr-resolution` | #108 已合并；修复 PR 待创建 | 执行 session（待用户启动） | PR #113 已由真实 Sync Upstream 创建但冲突；修复新建 PR 编号解析，排除 `AIO-PENDING-029`。 |
