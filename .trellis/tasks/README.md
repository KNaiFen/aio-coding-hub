...
|---|---|---|---|---|---|---|---|---|
| [`08-13-cross-provider-model-routing`](./08-13-cross-provider-model-routing/) | in_progress（Round 1 待返工） | `feat/cross-provider-model-routing` | `875ff441c5ba9f1a7f235ad95dadb945a41bba61` | `c6d59507c7a1de46abdb07427aa8bc153c69739c` | `/Users/knaifen/Documents/Codex/aio-coding-hub/08-13-cross-provider-model-routing` | [#137](https://github.com/KNaiFen/aio-coding-hub/pull/137) | 执行 session 待返工；main 已交回唯一写权 | main 于 2026-08-14 07:32:54 CST 临时接管冻结 head `bbe3e8bb96ef09cdff6b791b7ee4d1d9c29b9f4d` 的记录性文档，07:34:17 CST 交回；按 `findings.md` F-001 同步已合并的基线修复 `a0f6823b...` 并重取完整 CI。 |
