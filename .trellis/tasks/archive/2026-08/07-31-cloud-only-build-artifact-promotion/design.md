...
- Protect `main` with required PR/CI and no force-push/deletion, and protect `aio-coding-hub-v*` against unauthorized creation, update and deletion. Environment tag-name matching alone is not an ancestry or authorization boundary.
