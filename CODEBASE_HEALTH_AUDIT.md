...
| 3 | `.trellis/tasks/08-06-request-runtime-log-retention` / `codex/aud018-request-runtime-log-retention` | `AUD-056` | 代码候选 `28d65b2d`：7 天请求/运行日志、ledger 永久保留、256 MiB 软上限、活动文件保护、freelist 可见、不自动 VACUUM。 | PR、云端完整跨层门、bindings 核验与合并待执行；当前不阻塞后续代码。 |
