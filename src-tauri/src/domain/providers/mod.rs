...
pub(crate) use queries::{
    ...
    get_oauth_details_for_credential, get_source_provider_for_availability,
    get_source_provider_for_gateway, list_enabled_for_gateway_in_mode_selection,
    ...
    resolve_effective_transport_credential_for_probe,
