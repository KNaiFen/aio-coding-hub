...
macro_rules! generated_command_registry {
    ($callback:ident) => {{
        $callback! {
            ...
            cli_manager_codex_context_window_372k_get => crate::commands::cli_manager::cli_manager_codex_context_window_372k_get,
            cli_manager_codex_context_window_372k_set => crate::commands::cli_manager::cli_manager_codex_context_window_372k_set,
            ...
            gateway_bearer_token_reveal => crate::commands::gateway::gateway_bearer_token_reveal,
            gateway_bearer_token_rotate => crate::commands::gateway::gateway_bearer_token_rotate,
            gateway_bearer_token_acknowledge => crate::commands::gateway::gateway_bearer_token_acknowledge,
