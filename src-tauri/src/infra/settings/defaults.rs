...
pub const DEFAULT_PROVIDER_AVAILABILITY_HOURS: u32 = 6;
...
pub(super) const SCHEMA_VERSION_ADD_CODEX_RESPONSES_OVERLOAD_ERROR_REWRITE: u32 = 61;
pub(super) const SCHEMA_VERSION_ADD_CODEX_MODEL_CATALOG_FORWARDING: u32 = 62;
...
pub(super) const DEFAULT_ENABLE_CODEX_RESPONSES_OVERLOAD_ERROR_REWRITE: bool = false;
pub(super) const DEFAULT_FORWARD_CODEX_MODEL_CATALOG: bool = true;
