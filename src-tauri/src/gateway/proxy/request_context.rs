...
pub(super) struct RequestContext<R: tauri::Runtime = tauri::Wry> {
    ...
    pub(super) route_generation: crate::session_manager::SessionRouteGeneration,
    ...
    #[allow(dead_code)] // Used by one-shot cross-provider failover work items.
    pub(super) effective_sort_mode_uuid: Option<String>,
    pub(super) providers: Vec<providers::ProviderForGateway>,
    #[allow(dead_code)] // Full request-time member snapshot; independent of baseline filtering.
