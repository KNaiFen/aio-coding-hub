...
```bash
scripts/gkd-verify --base-sha <full-task-base-sha>
```
...
- [GKD task directory](tasks/): requirements, plans, delivery, and acceptance facts generated by the canonical bundle.
